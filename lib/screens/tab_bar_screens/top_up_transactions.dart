...
class TopUpTransactions extends StatefulWidget {
  @override
  _TopUpTransactionsState createState() => _TopUpTransactionsState();
}

class _TopUpTransactionsState extends State<TopUpTransactions> {
          ...
          return snapshot.data
              ...
              ? Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'You have not made any Top-Up transactions ',
  ...
  List<Widget> _sliverList(BuildContext context, List transactions) {
